...
print(z + 'Mr./Ms. ' + name1_Full.format('Archibald', 'Montague',
                                         'Abercrombie') + z0)
print(z + 'Dear ' + name1_Name.format('Archibald') + z0)
print(y)
print(z + name1_Full.format('Abercrombie,', 'Archibald', 'Montague')
        + z0 + '\n')
print(z + name1_Full.format('Cleopatra', 'Anastasia', 'Montgomery') + z0)
print(z + name1_FirstLast.format('Cleopatra', 'Montgomery') + z0)
print(z + 'Mr./Ms. ' + name1_Full.format('Cleopatra', 'Anastasia',
                                         'Montgomery') + z0)
